    ...
    public partial class CreateData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameMatchedNames", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameMatchedNames_Game_GameId",
                        column: x => x.GameId,
                        principalTable: "Game",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameSecretNames", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameSecretNames_Game_GameId",
                        column: x => x.GameId,
                        principalTable: "Game",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameMatchedNames_GameId",
                table: "GameMatchedNames",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_GameSecretNames_GameId",
                table: "GameSecretNames",
                column: "GameId");
